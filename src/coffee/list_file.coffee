...
$ ->
    ...
    sync_for_dropbox = get_sync_func window.dropbox_sync_api_url
    sync_for_user = get_sync_func window.sync_api_url
    $('.sync_for_dropbox').click sync_for_dropbox
    $('.sync_for_user').click sync_for_user
